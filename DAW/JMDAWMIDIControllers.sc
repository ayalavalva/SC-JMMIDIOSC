JMDAWMIDIControllers {
    var <>postMIDIOSC; // [TODO] Maybe postMIDIOSC is not needed as a variable in this class
    ...
    *new { |postMIDIOSC|
    ...
    init { |postMIDIOSC|
        ...
        this.pbf42 = JMIntechPBF4(midiChannel: 0, startCC: 84, oscServAddr: "127.0.0.1", oscServPort: 9000, postMIDIOSC: this.postMIDIOSC);
    }
}

// Maybe add the MIDI initialization process in a method here